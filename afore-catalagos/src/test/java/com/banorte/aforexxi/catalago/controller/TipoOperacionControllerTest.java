...
public class TipoOperacionControllerTest {
  ...
  private static final String URI = "/catServices/getTipoOperacion";
  ...
  @Test
  public void debeObtenerTodaListaTramites() {
  ...
  @Test
  public void obtenerError409() {
    ResponseEntity<CustomErrorResponse> response = restTemplate.exchange(URI + "/1", HttpMethod.GET,
        this.entity, CustomErrorResponse.class);
